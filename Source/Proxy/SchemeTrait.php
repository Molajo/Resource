...
trait SchemeTrait
{
    ...
    public function setScheme($scheme_name, ResourceInterface $adapter, array $extensions = array())
    {
        ...
        $this->requested_adapter->setResourceGetCallback($this->get_resource_callback);
    ...
    {
        $this->requested_scheme = parse_url($uri, PHP_URL_SCHEME);

        if ($this->requested_scheme === false) {
