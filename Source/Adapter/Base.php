...
abstract class Base extends Cache
{
     ...
     *
     * @param   callback $get_resource_callback
     *
     * @return  $this
     * @since   1.0.0
     */
    public function setResourceGetCallback(callable $get_resource_callback)
    {
        $this->get_resource_callback = $get_resource_callback;
