...
class CacheInjector extends AbstractInjector implements ServiceHandlerInterface
{
    ...
    {
        $cache_handler = $this->dependencies['Parameters']->application->parameters->cache_handler;
    ...
    {
        $options                  = array();
        $options['cache_time']    = $this->dependencies['Parameters']->application->parameters->cache_time;
        $options['cache_folder']  = $this->dependencies['Parameters']->site->cache_folder;
        $options['cache_service'] = $this->dependencies['Parameters']->application->parameters->cache_service;
