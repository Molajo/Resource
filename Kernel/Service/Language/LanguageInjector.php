...
class LanguageInjector extends AbstractInjector implements ServiceHandlerInterface
{
    ...
    {
        $application_id        = $this->dependencies['Parameters']->application->id;
    ...
    protected function setLanguage()
    {
        ...
        $language = $this->dependencies['Parameters']->application->parameters->language;
        if (in_array($language, $this->tag_array)) {
            return $language;
        }
    ...
    public function scheduleNextService()
    {
        ...
        $css_options['language_direction']
            = $this->dependencies['Parameters']->application->parameters->language_direction;
        $css_options['html5']
            = $this->dependencies['Parameters']->application->parameters->application_html5;
        $css_options['line_end']
            = $this->dependencies['Parameters']->application->parameters->application_line_end;
//$css_options['mimetype']
//          = $this->dependencies['Parameters']->application->parameters->application_mimetype;
