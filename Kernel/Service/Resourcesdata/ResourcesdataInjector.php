...
class ResourcesdataInjector extends AbstractInjector implements ServiceHandlerInterface
{
    ...
    protected function createDataobjectHandler()
    {
        ...
        try {
            ...
            throw new ServiceHandlerException ('Resources Data Injector createDataobjectHandler failed: '
            . $e->getMessage());
        }
    ...
    protected function createModelHandler()
    {
        ...
        try {
            ...
            throw new ServiceHandlerException ('Resources Data Injector createModelHandler failed: '
            . $e->getMessage());
        }
    ...
    public function createXmlHandler($model_handler, $dataobject_handler)
    {
        ...
        try {
            $xmlHandler = new $class ($model_handler, $dataobject_handler);

        } catch (Exception $e) {
            throw new ServiceHandlerException ('Resources Data Injector createXmlHandler failed: '
            . $e->getMessage());
        }
