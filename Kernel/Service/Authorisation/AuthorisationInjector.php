...
class AuthorisationInjector extends AbstractInjector implements ServiceHandlerInterface
{
    ...
    public function processFulfilledDependencies(array $dependency_instances = null)
    {
        ...
        $this->dependencies['application_id']            = $this->dependencies['Parameters']->application_id;
        ...
        $this->dependencies['default_exception']         = 'Molajo\\User\\Exception\\AuthorisationException';
    ...
    protected function getAdapterHandler()
    {
        ...
        try {
            return new $class(
                ...
                $this->dependencies['default_exception'],
