...
class EmailInjector extends AbstractInjector implements ServiceHandlerInterface
{
    ...
    public function processFulfilledDependencies(array $dependency_instances = null)
    {
        ...
        $this->dependencies['mailer_transport']
            = $this->dependencies['Parameters']->application->parameters->mailer_transport;

        $this->dependencies['site_name']
            = $this->dependencies['Parameters']->application->parameters->application_name;

        switch ($this->dependencies['Parameters']->application->parameters->mailer_transport) {

            case 'smtp':
                $this->dependencies['smtpauth']
                    = $this->dependencies['Parameters']->application->parameters->mailer_smtpauth;
                $this->dependencies['smtphost']
                    = $this->dependencies['Parameters']->application->parameters->mailer_smtphost;
                $this->dependencies['smtpuser']
                    = $this->dependencies['Parameters']->application->parameters->mailer_smtpuser;
                $this->dependencies['smtppass']
                    = $this->dependencies['Parameters']->application->parameters->mailer_smtppass;
                $this->dependencies['smtpsecure']
                    = $this->dependencies['Parameters']->application->parameters->mailer_smtpsecure;
                $this->dependencies['smtpport']
                    = $this->dependencies['Parameters']->application->parameters->mailer_smtpport;

                break;

            case 'sendmail':
                $this->dependencies['sendmail_path'] = $this->dependencies['Parameters']->application->parameters->mailer_send_mail;
        ...
        $this->dependencies['to']
            = $this->dependencies['Parameters']->application->parameters->mailer_only_deliver_to;
        $this->dependencies['from']
            = $this->dependencies['Parameters']->application->parameters->mailer_mail_from;
        $this->dependencies['reply_to']
                                             = $this->dependencies['Parameters']->application->parameters->mailer_mail_reply_to;
        $this->dependencies['email_handler'] = 'phpMailer';
//= $this->dependencies['Parameters']->application->parameters->email_handler;
        $this->dependencies['mailer_disable_sending']
            = $this->dependencies['Parameters']->application->parameters->mailer_disable_sending;
        $this->dependencies['mailer_disable_sending']
            = 1;
