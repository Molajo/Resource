...
class AbstractInjector implements ServiceHandlerInterface
{
    ...
    /**
     * Services to request the IoCController set using the Container setServices method
     *
     * @var     array
     * @since   1.0
     */
    ...
    /**
     * Services to request the IoCController remove using the Container setServices method
     *
     * @var     array
     * @since   1.0
     */
    ...
    /**
     * Services to request the IoCController schedule for class creation
     *
     * @var     array
     * @since   1.0
     */
