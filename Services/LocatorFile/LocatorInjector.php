<?php
/**
 * Locator File Injector
 *
 * @package   Molajo
 * @license   http:/www.opensource.org/licenses/mit-license.html MIT License
 * @copyright 2013 Amy Stephen. All rights reserved.
 */
namespace Molajo\Service\LocateFile;
...
/**
 * Locator File Dependency Injector
 *
 * @author    Amy Stephen
 * @license   http:/www.opensource.org/licenses/mit-license.html MIT License
 * @copyright 2013 Amy Stephen. All rights reserved.
 * @since     1.0
 */
class LocateFileInjector extends CustomInjector implements ServiceItemInterface
{
    /**
     * Constructor
     *
    ...
    public function __construct(array $options = array())
    {
        ...
        $this->service_namespace        = 'Molajo\\Locator\\Handler\\FileLocator';
