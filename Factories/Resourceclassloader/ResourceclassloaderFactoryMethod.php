<?php
/**
 * Resourceclassloader Factory Method
 *
 * @package    Molajo
 * @license    http://www.opensource.org/licenses/mit-license.html MIT License
 * @copyright  2014-2015 Amy Stephen. All rights reserved.
 */
namespace Molajo\Factories\Resourceclassloader;
 ...
 * @since      1.0
 */
class ResourceclassloaderFactoryMethod extends FactoryMethodBase implements FactoryInterface, FactoryBatchInterface
{
    /**
     * Constructor
     *
    ...
    {
        $options['product_namespace']        = 'Molajo\\Resource\\Adapter\\ClassLoader';
    ...
    public function scheduleFactories()
    {
        ...
        $options['scheme_name']           = 'ClassLoader';
        $options['product_namespace']     = $this->product_namespace;
        $options['valid_file_extensions'] = array('.php');
