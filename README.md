...
3. **$loader_type_chain** one or more field handlers, separated by a comma, processed in left-to-right order;
...
```php
    ...
    $loader_type_chain = array('int', 'default', 'required', 'foreignkey');
    $options = array('default' => 14, 'required' => true, 'foreignkey' => 'id', 'table' => 'extensions');

    try {
        $validated_value = $adapter->validate('extension_id', 12, $loader_type_chain, $options);
...
- [Accepted](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#accepted)
- [Alias](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#alias)
- [Alpha](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#alpha)
- [Alphanumeric](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#alphanumeric)
- [Arrays](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#arrays)
- [Boolean](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#boolean)
- [Callback](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#callback)
- [Contains](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#contains)
- [Date](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#date)
- [Defaults](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#default)
- [Digit](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#digit)
- [Email](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#email)
- [Encoded](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#encoded)
- [Equals](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#equals)
- [Extensions](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#extensions)
- [Float](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#float)
- [Foreignkey](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#foreignkey)
- [Fromto](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#Fromto)
- [Fullspecialchars](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#fullspecialchars)
- [Html](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#html)
- [Int](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#int)
- [Ip](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#ip)
- [Lower](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#lower)
- [Maximum](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#maximum)
- [Mimetypes](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#mimetypes)
- [Minimum](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#minimum)
- [NotEqual](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#notequal)
- [Numeric](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#numeric)
- [Object](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#object)
- [Raw](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#raw)
- [Regex](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#regex)
- [Required](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#required)
- [String](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#string)
- [Stringlength](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#stringlength)
- [Time](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#time)
- [Trim](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#trim)
- [Upper](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#upper)
- [Url](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#url)
- [Values](https://github.com/Molajo/Standard/tree/master/Vendor/Molajo/Locator#values)

The examples in this section assume the *Locator* has been instantiated, as follows:
...
```php
    ...
    $field_value             = 1;
    $loader_type_chain = 'Foreignkey';
    $options                 = array();
    $options['database']     = $database;
    $options['table']        = 'molajo_actions';
    $options['key']          = 'id';

    $results = $adapter->validate($field_name, $field_value, $loader_type_chain, $options);
...
```php
    $field_name              = 'my_field';
    $field_value             = '&';
    $loader_type_chain = 'Fullspecialchars';
    $options                 = array();
...
```php
    ...
    $loader_type_chain = 'Regex';
    $options                 = array();
    $options['regex']      = $regex_expression;

    $results = $adapter->validate($field_name, $field_value, $loader_type_chain);
...
```php
    ...
    $field_name              = 'my_field';
    $field_value             = 'Lots of stuff in here that is stringy.          ';
    $loader_type_chain = 'Trim';

    $results = $adapter->filter($field_name, $field_value, $loader_type_chain);
```
