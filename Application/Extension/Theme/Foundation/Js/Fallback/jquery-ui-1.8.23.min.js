...
(function (a, b) {
    ...
    var c, d, e, f, g = "ui-button ui-widget ui-state-default ui-corner-all", h = "ui-state-hover ui-state-active ", i = "uibuttonicons-only uibuttonicon-only uibuttontext-icons uibuttontext-icon-primary uibuttontext-icon-secondary uibuttontext-only", j = function () {
    ...
    a.widget("ui.button", {options: {disabled: null, text: !0, label: null, icons: {primary: null, secondary: null}}, _create: function () {
        ...
        this.element.removeClass("ui-helper-hidden-accessible"), this.buttonElement.removeClass(g + " " + h + " " + i).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".uibuttontext").html()), this.hasTitle || this.buttonElement.removeAttr("title"), a.Widget.prototype.destroy.call(this)
    }, _setOption: function (b, c) {
        a.Widget.prototype._setOption.apply(this, arguments);
        if (b === "disabled") {
        ...
        var b = this.buttonElement.removeClass(i), c = a("<span></span>", this.element[0].ownerDocument).addClass("uibuttontext").html(this.options.label).appendTo(b.empty()).text(), d = this.options.icons, e = d.primary && d.secondary, f = [];
        d.primary || d.secondary ? (this.options.text && f.push("uibuttontext-icon" + (e ? "s" : d.primary ? "-primary" : "-secondary")), d.primary && b.prepend("<span class='uibuttonicon-primary ui-icon " + d.primary + "'></span>"), d.secondary && b.append("<span class='uibuttonicon-secondary ui-icon " + d.secondary + "'></span>"), this.options.text || (f.push(e ? "uibuttonicons-only" : "uibuttonicon-only"), this.hasTitle || b.attr("title", c))) : f.push("uibuttontext-only"), b.addClass(f.join(" "))
