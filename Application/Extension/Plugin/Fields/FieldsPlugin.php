 ...
 * @since       1.0
 */
class FieldsPlugin extends AbstractPlugin
{
    /**
    ...
    public function onBeforeInclude()
    {
        ...
        $extended_literal    = ' (' . $this->language->translate('extended') . ')';
        $parameter_literal   = ' (' . $this->language->translate('parameter') . ')';
        $customfield_literal = ' (' . $this->language->translate('customfield') . ')';
        $metadata_literal    = ' (' . $this->language->translate('metadata') . ')';
...
//$exists = $this->registry->exists($model_registry, 'customfieldgroups');
        ...
        $this->registry->set('Datalist', $model_registry . 'Fields', $fieldArray);
        $this->registry->set('Datalist', $model_registry . 'Fieldsstandard', $standardArray);
        $this->registry->set('Datalist', $model_registry . 'Metadata', $metadataArray);
        $this->registry->set(
            'Datalist',
            $model_registry . 'Fieldsparameters',
            $parametersArray
        );
        $this->registry->set('Datalist', $model_registry . 'Fieldscustom', $customFieldArray);
