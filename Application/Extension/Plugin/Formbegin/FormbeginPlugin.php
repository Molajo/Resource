 ...
 * @since       1.0
 */
class FormbeginPlugin extends AbstractPlugin
{
    ...
    public function onAfterReadAll()
    {
        ...
        if ($form_action == '' || $form_action === null) {
            $form_action = ' action="' . $this->registry->get('Page', 'page_url') . '"';
        } else {
        ...
        if ($form_name == '' || $form_name === null) {
            $form_name = ' name="' . $this->registry->get(
                    'RouteParameters',
